...
export default function ListPropertyCta() {
  ...
  return (
    <section className="py-8 [content-visibility:auto] [contain-intrinsic-size:1px_200px]">
      <div className="flex flex-col items-center justify-between gap-6 rounded-2xl bg-gradient-to-r from-yellow-400 to-amber-500 px-8 py-10 text-black shadow-lg md:flex-row md:px-12">
        ...
        <Link to="/auth/register" className="shrink-0">
          <Button
            size="lg"
            className="h-12 rounded-xl bg-black px-8 font-semibold text-white shadow-md hover:bg-gray-900"
          >
