...
export default function Login() {
  ...
  const formSurface = (
    <div className="w-full max-w-[460px] bg-white p-6 sm:p-8 lg:p-10">
      ...
      <div className="space-y-3">
        <button
          ...
          className="flex h-12 w-full items-center justify-center gap-3 rounded-full border border-border bg-card px-4 text-sm font-semibold text-foreground transition-all hover:bg-accent disabled:cursor-not-allowed disabled:opacity-50"
        >
          {isGoogleLoading ? (
      ...
      <form onSubmit={formik.handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className={cn(
              "h-12 w-full rounded-xl border bg-card px-4 text-sm text-foreground outline-none transition-all placeholder:text-muted-foreground",
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              ...
              className={cn(
                "h-12 w-full rounded-xl border bg-card px-4 pr-12 text-sm text-foreground outline-none transition-all placeholder:text-muted-foreground",
                "focus:border-primary focus:ring-4 focus:ring-primary/10",
        ...
        <button
          type="submit"
          disabled={formik.isSubmitting}
          className="flex h-12 w-full items-center justify-center rounded-full bg-primary px-4 text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-60"
        >
          {formik.isSubmitting ? (
            <Loader2 className="h-5 w-5 animate-spin" />
          ) : (
