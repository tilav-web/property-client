...
export interface LandRentFormData {
  area: number | string;
...
interface Props {
  data: LandRentFormData;
  setData: (data: LandRentFormData) => void;
  isSubmitting?: boolean;
}

const defaultFormData: LandRentFormData = {
  area: "",
  land_type: "",
...
export default function LandRentForm({ data, setData, isSubmitting = false }: Props) {
  ...
  return (
    <Card className="mt-6">
      <CardHeader>
        <CardTitle>
          {t("property_form.land_rent.title", { defaultValue: "Yer ijarasi — tafsilotlar" })}
        </CardTitle>
      </CardHeader>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setData({ ...formData, land_type: v as LandRentFormData["land_type"] })}
              disabled={isSubmitting}
            >
              <SelectTrigger>
