...
const validationSchema = (t: any) => Yup.object({
  first_name: Yup.string().required(t("physical_seller_register.first_name_required")),
  last_name: Yup.string().required(t("physical_seller_register.last_name_required")),
  middle_name: Yup.string().required(t("physical_seller_register.middle_name_required")),
  birth_date: Yup.string().required(t("physical_seller_register.birth_date_required")),
  jshshir: Yup.string()
...
export default function SelfEmployedForm() {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-semibold text-gray-900">{t("physical_seller_register.self_employed_details")}</h3>

      <form onSubmit={formik.handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="first_name">{t("physical_seller_register.first_name")}</Label>
            <Input
              id="first_name"
          ...
          <div className="space-y-2">
            <Label htmlFor="last_name">{t("physical_seller_register.last_name")}</Label>
        ...
        <div className="space-y-2">
          <Label htmlFor="middle_name">{t("physical_seller_register.middle_name")}</Label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="birth_date">{t("physical_seller_register.birth_date")}</Label>
            <Input
              id="birth_date"
              type="date"
          ...
          <div className="space-y-2">
            <Label htmlFor="jshshir">{t("physical_seller_register.jshshir")}</Label>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            type="file"
            onChange={(event) => {
              formik.setFieldValue("passport_file", event.currentTarget.files?.[0]);
            }}
          />
        </div>
        ...
        <div className="flex items-center justify-end">
          <NextButton type="submit" loading={formik.isSubmitting} />
        </div>
      </form>
    </div>
  );
