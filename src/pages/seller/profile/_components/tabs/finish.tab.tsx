...
export default function FinishTab() {
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto p-6">
      ...
      {/* Keyingi qadamlar */}
      <div className="bg-gray-50 border border-border/60 rounded-lg p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            <div className="w-6 h-6 bg-gray-300 text-muted-foreground rounded-full flex items-center justify-center text-sm font-bold">
              2
            </div>
            <span className="text-muted-foreground">{t("finish_tab.admin_approval")}</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-6 h-6 bg-gray-300 text-muted-foreground rounded-full flex items-center justify-center text-sm font-bold">
              3
      ...
      <div className="pt-4">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div
            className="bg-primary h-2 rounded-full w-1/3 animate-pulse"
